...
public class Personel extends Kisi{
    ...
    public void izinAl(){
        ...
        if (istenenIzin>izinHakki) {
            System.out.println("O kadar izin hakkınız bulunmamaktadır.");
        }else {
            setIzinHakki(izinHakki-istenenIzin);
            System.out.println("İzniniz kabul olmuştur. Kalan izin hakkınız : " + izinHakki);
        }
    }
    ...
    public void raporAl(){
        ...
        if (istenenRaporGunu>raporHakki) {
            System.out.println("O kadar rapor hakkınız bulunmamaktadır.");
        }else {
            setRaporHakki(raporHakki-istenenRaporGunu);
            System.out.println("Rapor kabul olmuştur. Kalan rapor hakkınız : " + this.raporHakki);
        }
    }
}
