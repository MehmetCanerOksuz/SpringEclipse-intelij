...
public class AppMain {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(ogrenciList2);
        ...
        ogrenciList3.add("Ali");
        ogrenciList3.add("Ali");
        //ogrenciList3.add(null);   //TreeSet null kabul etmez!!!!!!!!!!!!!!!!!!!!!

        System.out.println(ogrenciList3);
        ...
        System.out.println(ogrenciList4);

        Set<Integer> ogrenciList5 = new HashSet<>();
        ogrenciList5.add(5);
    }
}
